...
This roadmap describes the evolution of YummyGraph's type-resolution layer from a receiver-disambiguation aid into a production-grade static-analysis foundation.
...
For YummyGraph, production-grade does **not** mean replacing a language compiler. The target:
