 ...
 *
 * Historically defined in `yummygraph/src/core/ingestion/model/symbol-table.ts`;
 * moved into `yummygraph-shared` as part of RFC #909 Ring 1 (#910) so the
 * scope-resolution types that reference it can live in the shared package
 * alongside their consumers (`yummygraph/` and `yummygraph-web/`).
 *
