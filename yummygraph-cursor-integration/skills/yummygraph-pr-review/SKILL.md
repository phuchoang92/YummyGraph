...
5. READ yummygraph://repo/{name}/processes                   → Check affected execution flows
6. Summarize findings with risk assessment
```

> If "Index is stale" → run `node .yummygraph/run.cjs analyze` in terminal before reviewing.
...
| Dimension | How YummyGraph Helps |
| --- | --- |
...
1. **[severity]** Description of finding
   - Evidence from YummyGraph tools
